...
function LandingPage() {
  ...
  const addCart = useCallback(async (productId, quantity) => {
    ...
    try {
      await axios.post("https://watch-ecom-beryl.vercel.app/cart/addtocart", { userId, productId, quantity });
  ...
  const updateQuantity = useCallback(async () => {
    ...
    try {
      // Get the user's cart
      const cartRes = await axios.post(`https://watch-ecom-beryl.vercel.app/cart/get-cart`, { userId });
      ...
      if (cart && cart.productsInCart && Array.isArray(cart.productsInCart)) {
        ...
        for (let item of cart.productsInCart) {
          ...
          try {
            await axios.put("https://watch-ecom-beryl.vercel.app/cart/update-quantity", { userId, productId: item.productId, productQty: newQuantity });
          } catch (error) {
