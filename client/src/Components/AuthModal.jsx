  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (role === 'seller') {
        ...
        if (isSignUp) {
          response = await axios.post('https://watch-ecom-beryl.vercel.app/auth/seller/signup', {
            name,
            email,
            password,
            phone,
          ...
          response = await axios.post('https://watch-ecom-beryl.vercel.app/auth/seller/login', {
            email,
            password,
          });
        ...
        if (isSignUp) {
          response = await axios.post('https://watch-ecom-beryl.vercel.app/auth/signup', {
            name,
            email,
            password,
            role,
          ...
          response = await axios.post('https://watch-ecom-beryl.vercel.app/auth/login', {
            email,
            password,
          });
