...
const products=require('./scripts/fakeProducts.js')
const app = express();

// Middleware
app.use(cors({
  origin: ['http://localhost:3000',"http://localhost:5173",'https://merabestie.com','https://hosteecommerce.vercel.app','https://watch-ecom-hu83.vercel.app/'], 
  credentials: true,
...
app.post('/create-product', async (req, res) => {
  try {
    ...
    const productId = req.body.productId || new mongoose.Types.ObjectId().toString();

    const newProduct = await Product.create({ name, price, category, productId });
